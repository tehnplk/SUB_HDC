...
export default function DmHtCountDashboard() {
      ...
      <section className="panel panelWide dashboardPanel">
        ...
        <div className="statGrid personTargetStatGrid">
          <div className="statCard">
            ...
            <span className="statValue">{loading ? "…" : formatNumber(summary?.patients)}</span>
            <span className="statLabel">ผู้ป่วยรวม (คน)</span>
          </div>
          <div className="statCard">
        ...
        <div className="tableMeta personTargetMeta">
          <span><TableProperties aria-hidden="true" /> {loading ? "กำลังโหลดข้อมูล..." : "ขึ้นทะเบียนตาม TYPEAREA 1 และ 3"}</span>
