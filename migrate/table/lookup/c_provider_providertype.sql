-- Source: MOPH 43-file official code sheet (healthinformationmoph Google Drive), PROVIDER.PROVIDERTYPE
SET NAMES utf8mb3;

CREATE TABLE IF NOT EXISTS `c_provider_providertype` (
  `code` varchar(3) NOT NULL,
  `providertype_name` varchar(255) NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

ALTER TABLE `c_provider_providertype`
  ADD COLUMN IF NOT EXISTS `is_active` tinyint(1) NOT NULL DEFAULT 1;

START TRANSACTION;

DELETE FROM `c_provider_providertype`;

INSERT INTO `c_provider_providertype` (`code`, `providertype_name`) VALUES
  ('01', 'แพทย์'),
